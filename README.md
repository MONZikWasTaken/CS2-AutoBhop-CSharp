...
# ПРОЧИТАЙ
**Перенесено с [АХК](https://github.com/MONZikWasTaken?tab=repositories) который использовал ([Tweek](https://www.youtube.com/watch?v=oxTDG69jFM8&t=436s)) на C# потому что у большинства людей были ошибки** 
